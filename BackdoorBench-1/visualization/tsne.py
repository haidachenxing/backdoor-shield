...
from visual_utils import * # 引入参数设置
...
cam = FullGrad(model=model_attack, target_layers=target_layers) # 我删除了参数use_cuda=True
...
if args.result_file_defense!='None':
    ...
    cam = FullGrad(model=model_defense, target_layers=target_layers) # 删除了参数use_cuda=True
