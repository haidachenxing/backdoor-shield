...
bd_test_original_index_array_length = len(bd_test_original_index)


# print("num_classes:", num_classes)
# print("model_name:", model_name)
# print("bd_train_y:", bd_train_y)
print('bd_train_x_array_length:', bd_train_x_array_length)
print('bd_train_y_array_length:', bd_train_y_array_length)
print('bd_train_original_index_array_length:', bd_train_original_index_array_length)
print('bd_test_x_array_length:', bd_test_x_array_length)
print('bd_test_y_array_length:', bd_test_y_array_length)
print('bd_test_original_index_array_length:', bd_test_original_index_array_length)
