...
urlpatterns = [
    ...
    path('test/ajax_path_dealer/', views.ajax_path_dealer, name='ajax_path_dealer'),
    path('test/record', views.upload_file, name='upload_file'),
    path('upload/', views.upload, name='test')
]
