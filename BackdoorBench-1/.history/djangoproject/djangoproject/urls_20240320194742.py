...
urlpatterns = [
    ...
    path('index/upload/execute_defense/', views.execute_defense, name='execute_defense'),
    path('index/upload/record', views.upload_file, name='upload_file'),
    path('index/upload/', views.upload, name='index_upload'),
