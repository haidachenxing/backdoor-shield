...
def ajax_path_dealer(request):
    if request.method == 'POST' and request.is_ajax():
        ...
        input_path = os.path.join(current_directory, "djangoproject\\djangoapp\\upload_file\\attack_result.pt")
        output_path = os.path.join(current_directory, "djangoproject\\djangoapp\\upload_file\\result.pt")
