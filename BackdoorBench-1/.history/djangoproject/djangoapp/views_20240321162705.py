...
def orders(request):
    if request.method == 'GET':
        ...
        data_dict = {
            (1,): {"num": 1, "name": "文件一", "type": "数据集防御", "data": "2021.10", "state": "已完成",
                   "scale": "30kb"},
            (2,): {"num": 2, "name": "文件二", "type": "模型防御1", "data": "2021.10", "state": "已完成",
                   "scale": "30kb"},
            (3,): {"num": 3, "name": "文件二", "type": "模型防御2", "data": "2021.10", "state": "未完成",
                   "scale": "30kb"},
            (4,): {"num": 4, "name": "文件二", "type": "模型防御3", "data": "2021.10", "state": "已完成",
                   "scale": "30kb"},
            (5,): {"num": 5, "name": "文件二", "type": "模型防御4", "data": "2021.10", "state": "已取消",
                   "scale": "30kb"},
        }  # 示例数据字典

        grouped_data = {
            "文件一": [item[1] for item in data_dict.items() if item[1]['state'] == "已完成"],
            "文件二": [item[1] for item in data_dict.items() if item[1]['state'] == "未完成"],
            "文件三": [item[1] for item in data_dict.items() if item[1]['state'] == "已取消"],
            "文件四": [item[1] for item in data_dict.items()],
        }
