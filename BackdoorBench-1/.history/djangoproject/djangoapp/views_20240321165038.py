    ...
    if request.method == 'GET':
        ...
        data_dict = {
            (1,): {"num": 1, "name": "file_1", "type": "数据集防御", "data": "2024-3-20", "state": "已完成",
                   "scale": "30kb"},
            (2,): {"num": 2, "name": "file_2", "type": "模型防御1", "data": "2021.10", "state": "已完成",
                   "scale": "30kb"},
            (3,): {"num": 3, "name": "file_2", "type": "模型防御2", "data": "2021.10", "state": "未完成",
                   "scale": "30kb"},
            (4,): {"num": 4, "name": "file_2", "type": "模型防御3", "data": "2021.10", "state": "已完成",
                   "scale": "30kb"},
            (5,): {"num": 5, "name": "file_2", "type": "模型防御4", "data": "2021.10", "state": "已取消",
                   "scale": "30kb"},
        }  # 示例数据字典
