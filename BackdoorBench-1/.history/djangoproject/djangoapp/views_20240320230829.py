...
def analyse(request):
    ...
    print(defense_algorithm)
    print(user_email)
    log_folder_path = 'D:/study/work/backdoorbench/BackdoorBench-1/djangoproject/record/hzzzzli@outlook.com/saved/ac/'
    ...
    if log_files:
        ...
        log_file_content = "No log files found in the folder."
