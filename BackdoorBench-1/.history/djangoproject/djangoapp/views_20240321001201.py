...
def analyse(request):
    ...
    return render(request, 'analyse.html', {'defense_algorithm': defense_algorithm, 'file_name': file_name, 'file_size': file_size, 'log_file_content': log_file_content, 'message': message})
