...
def ajax_path_dealer(request):
    if request.method == 'POST' and request.is_ajax():
        ...
        if response_data['defense_type'] == "ac":
            command = [
                "python", "../djangoapp/defense/ac/ac.py",
                "--yaml_path", "../djangoapp/config/defense/ac/cifar10.yaml",
                "--ratio", "0.01",
                "--acc_ratio", ".1",
                "--lr_scheduler", "CosineAnnealingLR",
                "--epochs", "2",
                "--input_path", "../djangoapp/upload_file/attack_result.pt",
                "--output_path", "./upload_file/result.pt"
            ]
